...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: `${siteConfig.site_domain}/health-industry`,
    },
    metadataBase: new URL(`${siteConfig.site_domain}/health-industry`),
    robots: {
        index: true,
        follow: true,
    },
            ...
            <main className='py-16'>
                <div className='container mx-auto px-4 max-w-4xl'>
                    ...
                    <p className='text-lg mb-10 text-muted-foreground'>
                        Every healthcare organization must have their specific
                        custom software. It helps in creating a strong and
                        well-built healthcare network. Our Odoo solutions in the
                        healthcare system allow us to help our clients overcome
                        the most alarming challenges. These include limited
                        communication and coordination, developing a connection
                        within disparate legacy health systems, overcoming
                        health illiteracy, and taking care of funds for
                        non-profit health care units.
                    </p>
                    <p className='text-lg mb-10 text-muted-foreground'>
                        Our Odoo-based healthcare system solutions facilitate a
                        simplified flow of administration, identification of
                        records, enhanced caregiving with timely updates, and
                        assessment and establishment of KPIs for better working.
                    </p>
