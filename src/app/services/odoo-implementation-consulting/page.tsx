                            ...
                            <div className='max-w-4xl mx-auto'>
                                <div className='text-center mb-12'>
                                    ...
                                    <p className='text-lg text-muted-foreground'>
                                        <strong>Odoo</strong>, being the
                                        limelight in today's fast-paced business
                                        world, has an excellent and efficient
                                        management system that is key to
                                        success. <strong>Odoo ERP</strong> is a
                                        powerful tool that brings together
                                        different parts of your business into
                                        one system for all the ongoing business
                                        operations, making your operations
                                        ...
                                        , providing customized solutions to meet
                        ...
                        <div className='container mx-auto px-4'>
                            <div className='max-w-6xl mx-auto'>
                                <h2 className='text-3xl font-bold text-center mb-12'>
                                    How Teckzilla Helps with Implementing Odoo
                                    ERP
                                </h2>
                                <p className='text-center text-lg text-muted-foreground mb-12'>
                                    Teckzilla is here to make your{' '}
                                    <strong>Odoo ERP implementation</strong>{' '}
                                    smooth and successful in areas of planning
                                    and executing workflow with higher value
                                    inputs just by one click. Odoo ERP is a
                                    powerful tool that enables your business
                                    operations to make quick decisions in a
                                    faster-paced working environment, and we, as
                                    an expert, help you get the most out of it.
                                </p>
                                ...
                                <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
                                    <Card>
                                        <CardContent className='p-6'>
                                            ...
                                            <p className='text-muted-foreground'>
                                                ...
                                                consists of smart technology
                                                that gives a 100% complete
                                                solution for business owners.
                                                Our team of certified Odoo
                                                experts understand the ins and
                                                outs of the software.
                                            </p>
                                        </CardContent>
                                    </Card>
                                    ...
                                    <Card>
                                        <CardContent className='p-6'>
                                            ...
                                            <p className='text-muted-foreground'>
                                                ...
                                                recognize this. We customize
                                                Odoo to match your business
                                                processes and functions, making
                                                sure it fits perfectly in the
                                                right manner.
                                            </p>
                                        </CardContent>
                                    </Card>
                                    ...
                                    <Card>
                                        <CardContent className='p-6'>
                                            ...
                                            <p className='text-muted-foreground'>
                                                ...
                                                Teckzilla provides thorough
                                                training for your team. We make
                                    ...
                                    <Card>
                                        <CardContent className='p-6'>
                                            ...
                                            <p className='text-muted-foreground'>
                                                Implementing an ERP system like
                                                Odoo can be challenging, but
                                                with Teckzilla, you are in good
                                                hands. Contact us today to learn
                    ...
                    <section className='bg-primary text-white py-16'>
                        <div className='container mx-auto px-4'>
                            <div className='max-w-4xl mx-auto text-center'>
                                ...
                                <p className='text-xl mb-8 opacity-90'>
                                    Contact Teckzilla today and get the best
