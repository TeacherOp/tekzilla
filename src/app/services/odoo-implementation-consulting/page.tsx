              ...
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-12">
                  ...
                  <p className="text-lg text-muted-foreground">
                    ...
                    together different parts of your business into one system
                    for all the ongoing business operations, making your
                    operations smoother and boosting your productivity level. At
                    Teckzilla, we excel in{" "}
                    <strong>
                      implementing and consulting Odoo ERP software
                    </strong>
                    , providing customized solutions to meet the specific needs
                    of each client.
                  </p>
                </div>
              </div>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-6xl mx-auto">
                ...
                <p className="text-center text-lg text-muted-foreground mb-12">
                  ...
                  faster-paced working environment, and we, as an expert, help
                  ...
                  <Card>
                    <CardContent className="p-6">
                      ...
                      <p className="text-muted-foreground">
                        ...
                        training for your team. We make sure everyone knows how
          ...
          <section className="bg-primary text-white py-16">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl mb-8 opacity-90">
                  Contact Teckzilla today and get the best Odoo ERP
