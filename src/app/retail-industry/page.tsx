            ...
            <main className='py-16'>
                <div className='container mx-auto px-4 max-w-4xl'>
                    ...
                    <p className='text-lg mb-10 text-muted-foreground'>
                        Use different sales channels to reach out to your
                        clients with Odoo. No matter if it’s a PoS, a CRM, or a
                        B2B network, Odoo facilitates perfection in all your
                        retail business activities. The most remarkable aspect
                        of using Odoo in retail is that you will have the
                        ability to integrate it with manufacturing, inventory
                        and purchase among other Odoo applications. At
                        Teckzilla, we allow you to get perfect retail management
                        for your retail as well as wholesale business. Our
                        expert team combines the best of Odoo’s solutions and
