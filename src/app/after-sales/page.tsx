            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  ...
                  end with just a sale. The customer still needs to be taken
                  care of with the product. We offer one of the best-in-industry
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-4xl mx-auto">
                While incorporating your operation processes with our systems,
                you might encounter some complications. That's why we provide
                comprehensive 360-degree after-sales management support to
                ensure your success.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <Card className="border-none shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Comprehensive training programs to ensure your team
              ...
              <Card className="border-none shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Fast response times with expert solutions to minimize
                    business disruption.
                  </p>
                </CardContent>
              </Card>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
              <div>
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  ...
                  that your investment in our solutions continues to deliver
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Build trust and loyalty through reliable support
                        services.
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="lg:order-2">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  For years we have been working with different top-tier
                  companies and helping them manage their systems with maximum
                  efficiency. Our years of experience deliver the most advanced
                  after-sales support services.
                </p>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Systematic feedback collection for continuous
                        improvement.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Ongoing training to maximize user adoption and
                        efficiency.
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <Card className="border-none shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Dedicated experts work on resolution with clear
