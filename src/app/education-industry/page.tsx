...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: `${siteConfig.site_domain}/education-industry`,
    },
    metadataBase: new URL(`${siteConfig.site_domain}/education-industry`),
    robots: {
        index: true,
        follow: true,
    },
            ...
            <main className='py-16'>
                <div className='container mx-auto px-4 max-w-4xl'>
                    ...
                    <p className='text-lg mb-10 text-muted-foreground'>
                        Teckzilla allows you to get the most effective Odoo
                        services for your educational institutions. With the
                        ability to customize Odoo implementation, we enable you
                        to acquire tech-based personalization and data. Odoo
                        helps us develop various types of systems that
                        effectively integrate technology into learning. Our
                        solutions like Learning Management systems, E-Learning
                        applications, and more make you ahead in the
                        international education world. ERP systems have proven
                        results in the education system and backing them up with
                        a strong set of tools as provided by Odoo would be the
