                        ...
                        <div className='grid lg:grid-cols-2 gap-12 items-center'>
                            <div>
                                ...
                                <p className='text-lg text-muted-foreground mb-8 leading-relaxed'>
                                    ...
                                    Services are the best suite of practices
                                    that will help you streamline all your
                                    business processes in a swift.
                                </p>
                                <Button
                                    size='lg'
                    ...
                    <div className='container mx-auto max-w-6xl'>
                        <div className='text-center mb-12'>
                            ...
                            <p className='text-lg text-muted-foreground max-w-3xl mx-auto'>
                                We have extensive experience in providing ERP
                                and CRM services to several companies and
                                organizations. Our consulting practices
                                incorporate analyzing Odoo customization,
                                implementation, training, migration, and
                                support.
                            </p>
                        </div>
                        ...
                        <div className='grid md:grid-cols-3 gap-8'>
                            <Card className='border-none shadow-lg hover:shadow-xl transition-shadow'>
                                <CardContent className='p-6 text-center'>
                                    ...
                                    <p className='text-muted-foreground'>
                                        Highly-integrated and economical
                            ...
                            <Card className='border-none shadow-lg hover:shadow-xl transition-shadow'>
                                <CardContent className='p-6 text-center'>
                                    ...
                                    <p className='text-muted-foreground'>
                                        Experienced consultants specialized in
                                        ERP and CRM solutions across various
                                        industries.
                                    </p>
                                </CardContent>
                            </Card>
                            ...
                            <Card className='border-none shadow-lg hover:shadow-xl transition-shadow'>
                                <CardContent className='p-6 text-center'>
                                    ...
                                    <p className='text-muted-foreground'>
                                        ...
                                        implementations handling accounting,
                        ...
                        <div className='grid lg:grid-cols-2 gap-12 items-center mb-16'>
                            <div>
                                ...
                                <p className='text-muted-foreground mb-6 leading-relaxed'>
                                    ...
                                    business requirements. We analyze your
                                    current processes and identify areas for
                        ...
                        <div className='grid lg:grid-cols-2 gap-12 items-center'>
                            <div className='lg:order-2'>
                                ...
                                <p className='text-muted-foreground mb-6 leading-relaxed'>
                                    ...
                                    align perfectly with your business workflow
                                    and operational requirements. Our bespoke
                                    approach ensures maximum efficiency and user
                                    adoption.
                                </p>
                                <ul className='space-y-2'>
                                    <li className='flex items-center text-muted-foreground'>
                ...
                <section className='py-16 px-4 bg-primary text-primary-foreground'>
                    <div className='container mx-auto max-w-4xl text-center'>
                        ...
                        <p className='text-xl mb-8 opacity-90'>
                            Get expert Odoo consultation and take your business
                            to the next level with our proven methodologies.
                        </p>
