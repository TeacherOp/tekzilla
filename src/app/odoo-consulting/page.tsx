            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  Entrepreneurs and businesses willing to get their businesses
                  on track have the ultimate deal. At Teckzilla, our Odoo
                  Development Services are the best suite of practices that will
                  help you streamline all your business processes in a swift.
                </p>
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                We have extensive experience in providing ERP and CRM services
                to several companies and organizations. Our consulting practices
              ...
              <Card className="border-none shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Highly-integrated and economical solutions customized for
                    your business needs and complexities.
                  </p>
                </CardContent>
              </Card>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
              <div>
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  ...
                  classification of business requirements. We analyze your
                  current processes and identify areas for improvement and
                  optimization.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="lg:order-2">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  We create customized mapping solutions that align perfectly
                  with your business workflow and operational requirements. Our
                  bespoke approach ensures maximum efficiency and user adoption.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center text-muted-foreground">
                    <CheckCircle className="h-4 w-4 text-primary mr-2" />
