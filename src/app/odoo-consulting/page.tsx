          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Entrepreneurs and businesses willing to get their businesses on
                track have the ultimate deal. At Teckzilla, our Odoo Development
                Services are the best suite of practices that will help you
                streamline all your business processes in a swift.
              </p>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              We have extensive experience in providing ERP and CRM services to
              several companies and organizations. Our consulting practices
              incorporate analyzing Odoo customization, implementation,
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground">
                  Highly-integrated and economical solutions customized for your
                  business needs and complexities.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground">
                  Experienced consultants specialized in ERP and CRM solutions
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground">
                  Track record of successful implementations handling
                  accounting, inventory, sales, and operations.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Odoo Consultation at Teckzilla caters identification and
                classification of business requirements. We analyze your current
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="lg:order-2">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                We create customized mapping solutions that align perfectly with
                your business workflow and operational requirements. Our bespoke
                approach ensures maximum efficiency and user adoption.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-muted-foreground">
                  <CheckCircle className="h-4 w-4 text-primary mr-2" />
            ...
            <div className="lg:order-1">
              <div className="bg-gradient-to-br from-primary/10 to-orange-500/10 p-8 rounded-2xl">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-background p-4 rounded-lg shadow-sm">
                    <h4 className="font-semibold text-sm mb-2">Optimization</h4>
                    <div className="h-2 bg-primary/20 rounded-full">
      ...
      <section className="py-16 px-4 bg-primary text-primary-foreground">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Get expert Odoo consultation and take your business to the next
            level with our proven methodologies.
          </p>
