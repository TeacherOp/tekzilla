            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  ...
                  implementation services. From planning to deployment, we
                  ensure a smooth transition to your new ERP system.
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Certified Odoo professionals with extensive
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Tailored solutions that fit your unique business
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Comprehensive post-implementation support and
