                        ...
                        <div className='grid lg:grid-cols-2 gap-12 items-center'>
                            <div>
                                ...
                                <p className='text-lg text-muted-foreground mb-8 leading-relaxed'>
                                    ...
                                    comprehensive Odoo implementation services.
                                    From planning to deployment, we ensure a
                                    smooth transition to your new ERP system.
                                </p>
                                <Button
                                    size='lg'
                    ...
                    <div className='container mx-auto max-w-6xl'>
                        <div className='text-center mb-12'>
                            ...
                            <p className='text-lg text-muted-foreground max-w-3xl mx-auto'>
                                ...
                                successful Odoo implementation with minimal
                                ...
                                <div className='space-y-6'>
                                    ...
                                    <div className='flex items-start space-x-4'>
                                        ...
                                        <div>
                                            ...
                                            <p className='text-muted-foreground'>
                                                Time-tested implementation
                                                approach ensuring project
