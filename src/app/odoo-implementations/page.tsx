                    ...
                    <div className='grid lg:grid-cols-2 gap-12 items-center'>
                        <div>
                            ...
                            <p className='text-lg text-muted-foreground mb-8 leading-relaxed'>
                                Transform your business operations with our
                                comprehensive Odoo implementation services. From
                                planning to deployment, we ensure a smooth
                ...
                <div className='container mx-auto max-w-6xl'>
                    <div className='text-center mb-12'>
                        ...
                        <p className='text-lg text-muted-foreground max-w-3xl mx-auto'>
                            We follow a proven methodology to ensure successful
                            Odoo implementation with minimal disruption to your
                            business.
                        </p>
                    </div>
                    ...
                    <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
                        <Card className='border-none shadow-lg hover:shadow-xl transition-shadow'>
                            <CardContent className='p-6 text-center'>
                                ...
                                <p className='text-muted-foreground'>
                                    ...
                                    requirement gathering to understand your
                                    needs.
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className='border-none shadow-lg hover:shadow-xl transition-shadow'>
                            <CardContent className='p-6 text-center'>
                                ...
                                <p className='text-muted-foreground'>
                                    ...
                                    development of your Odoo system.
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className='border-none shadow-lg hover:shadow-xl transition-shadow'>
                            <CardContent className='p-6 text-center'>
                                ...
                                <p className='text-muted-foreground'>
                                    Testing, training, data migration, and
                                    go-live support for seamless transition.
                                </p>
                            </CardContent>
                        </Card>
                    </div>
                            ...
                            <div className='space-y-6'>
                                <div className='flex items-start space-x-4'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-muted-foreground'>
                                            Certified Odoo professionals with
                                ...
                                <div className='flex items-start space-x-4'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-muted-foreground'>
                                            Time-tested implementation approach
                                            ensuring project success and minimal
                                            risk.
                                        </p>
                                    </div>
                                </div>
            ...
            <section className='py-16 px-4 bg-primary text-primary-foreground'>
                <div className='container mx-auto max-w-4xl text-center'>
                    ...
                    <p className='text-xl mb-8 opacity-90'>
                        Let our experts guide you through a successful Odoo
