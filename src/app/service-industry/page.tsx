      ...
      <main className="py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-lg mb-10 text-muted-foreground">
            The service industry is one of the sectors with extensive cut-throat
            competition. Meeting the expectations of a highly demanding consumer
            market is beyond a challenge. It doesn’t matter if you are just
            beginning or have established grounds, consumers will change their
            preference in less than a matter of time. So, Teckzilla caters to
            extensive solutions that allow you to enhance your digitisation
            journey and achieve exceptional customer delight using Odoo’s
            incredible data analytics and management. Recent statistics show
            that over 2 million people have been using Odoo for its amazing
            flexibility and high level of cost-saving. So, if you are willing to
            embrace digitization in your service industry business, then our
            Odoo implementation and integration solutions are right there to
