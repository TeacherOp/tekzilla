        ...
        <main>
            ...
            <section className='bg-primary text-primary-foreground'>
                <div className='container mx-auto px-4 py-12'>
                    ...
                    <p className='mt-3 max-w-2xl leading-relaxed mx-auto md:mx-0 text-center md:text-left'>
                        Join our team to build world-class Odoo and ERP
                        solutions. Explore open roles and apply today.
                    </p>
                </div>
            </section>
            ...
            <section className='container mx-auto px-4 py-10'>
                ...
                <p className='text-muted-foreground mb-6'>
                    Fill out the form below and attach your resume. Our team
            ...
            <section className='bg-secondary text-secondary-foreground'>
                <div className='container mx-auto px-4 py-10 space-y-6 '>
                    <p className=''>
                        We at Teckzilla consider our employees to be our most
                        valuable resource. We are considering the possibility of
                        recruiting you if you are a new technology startup that
                        is dedicated, purposeful, and anxious to establish a
                        reputation in the industry. Whether you’re an old hand
                        or just starting, Teckzilla is the place for you.
                    </p>
                    <h2 className='text-2xl font-semibold text-center md:text-left'>
                        Why choose Teckzilla?
                    </h2>
                    <p className=''>
                        Creativity and innovation are our strong suits with
                        which we respect and implement everyone’s ideas and
                        constantly push ourselves to think laterally. Your
                        professional development is our top priority. Your
                        potential is boundless when you have access to a wide
                        range of projects and work in an atmosphere that values
                        individual development. Integrate into a select cohort
                        of individuals who, despite leading radically dissimilar
                        lives, are united by an unwavering pursuit of excellence
                        and innovation.
                    </p>
                    <p className=''>
                        Are you ready to move up in your job? Check out our open
                        jobs to see how you can help shape the future of
                        technology at Teckzilla. Attend an organization where
                        your abilities are not only appreciated but also
                        commended. Go to our Careers page right now to send in
                        your application!
                    </p>
                    <p className=''>
