            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  Are you looking for integration services with third-party
                  tools? Odoo offers one of the best third-party integration
                  services, connecting your business with the boundary-less
                  external world.
                </p>
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-4xl mx-auto">
                ...
                third-party tool mechanisms in your system. No more suffering
                from long processes and inefficient working passages. Connect
                with Odoo to get one of the best web service application
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  We extend our services to various industries, from big to
                  small. Our customer support goes beyond the boundaries of
                  different software platforms with skillful services and latest
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="border-none shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Analyze current systems and identify integration
