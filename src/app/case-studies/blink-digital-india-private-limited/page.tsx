...
export const metadata: Metadata = {
    title: 'Blink Digital India Private Limited Case Study | Odoo ERP by Teckzilla',
    description:
...
const caseStudy = {
    ...
    modules: [
        {
            ...
            description:
                'To improve efficient manufacturing production processes',
            icon: '🏭',
        },
        {
    ...
    benefits: [
        ...
        },
        {
            title: 'Cost Savings',
            description:
                'Streamlined processes led to significant cost reductions.',
