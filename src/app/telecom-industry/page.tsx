            ...
            <main className='py-16'>
                <div className='container mx-auto px-4 max-w-4xl'>
                    ...
                    <p className='text-lg mb-10 text-muted-foreground'>
                        At Teckzilla, we serve our telecom clients with a
                        complete suite of Odoo solutions. Our extensive set of
                        solutions ensures that our clients get prompt
                        resolutions for any type of network disruption they
                        face. With the ability to integrate Odoo into telecom
                        inventory systems, telecom CRM, and telecom analytics,
                        we cater an exceptional set of services for all our
                        clients. As Odoo can cater to incredible integrations,
                        we use such capabilities to enable our clients to
                        acquire extensive ease in maintaining customer
                        satisfaction while using data for better service.
                    </p>
