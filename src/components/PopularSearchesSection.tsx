            ...
            <div className='container mx-auto px-4'>
                <div className='text-center mb-16'>
                    ...
                    <p className='text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed'>
                        When businesses explore Odoo ERP solutions, they often
                        search for trusted partners who can deliver proven
                        results. Depending on their location, industry, and
                        needs, these are the most common search terms:
                    </p>
                </div>
