                                ...
                                <div className='grid md:grid-cols-2 gap-6'>
                                    <Card>
                                        <CardContent className='p-6 text-center'>
                                            ...
                                            <p className='text-muted-foreground text-sm'>
                                                <a href='tel:+918233083333' className='hover:underline'>+91-8233083333</a>
                                            </p>
                                            <p className='text-muted-foreground text-sm'>
                                                <a href='tel:+919833765812' className='hover:underline'>+91-9833765812</a>
                                            </p>
                                            <p className='text-muted-foreground text-sm'>
                                                <a href='tel:+919137018743' className='hover:underline'>+91-9137018743</a>
                                            </p>
                                        </CardContent>
                                    </Card>
                                    ...
                                    <Card>
                                        <CardContent className='p-6 text-center'>
                                            ...
                                            <p className='text-muted-foreground text-sm'>
                                                <a href='mailto:sales@teckzilla.net' className='hover:underline'>sales@teckzilla.net</a>
                                            </p>
                                            <p className='text-muted-foreground text-sm'>
                                                <a href='mailto:info@teckzilla.net' className='hover:underline'>info@teckzilla.net</a>
                                            </p>
                                            <p className='text-muted-foreground text-sm'>
                                                <a href='mailto:girish.joshi@teckzilla.net' className='hover:underline'>girish.joshi@teckzilla.net</a>
                                            </p>
                                        </CardContent>
                                    </Card>
                                </div>
