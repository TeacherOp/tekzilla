            ...
            <div className='container mx-auto px-4'>
                ...
                <div className='text-center max-w-4xl mx-auto'>
                    <p className='text-lg text-muted-foreground mb-8 leading-relaxed'>
                        As an Odoo Gold Partner in Mumbai, India, Teckzilla
                        values adaptable solutions. Odoo ERP Software is highly
                        flexible, allowing you to customize it to fit your
                        company's needs and requirement. This adaptability helps
                        Odoo ERP grows with your business, providing scalability
                        and ongoing support with complete training.
                    </p>
                    <p className='text-lg text-muted-foreground mb-8 leading-relaxed'>
                        Ready to transform your business? Visit Teckzilla Odoo
                        Gold Partner to discover how Odoo ERP's latest features
                        can revolutionize your operations. Celebrate the future
                        of business management with Odoo ERP today!
                    </p>
