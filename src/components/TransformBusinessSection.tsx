                ...
                <div className='max-w-6xl mx-auto'>
                    <div className='grid lg:grid-cols-2 gap-12 items-center mb-16'>
                        ...
                        <Card className='card-corporate transition-all duration-300 hover:scale-[1.025] hover:shadow-2xl'>
                            <h4 className='text-xl font-bold mb-6 text-foreground'>
                                Why Choose an Odoo Gold Partner in Mumbai for
                                Your Business?
                            </h4>
                    ...
                    <Card className='m-20 mx-auto px-6 py-10 shadow-xl border-primary/15 border-2 bg-primary/5'>
                        <h4 className='text-xl md:text-2xl font-bold text-primary mb-2 text-center'>
                            Partnering With Teckzilla: Your Local Odoo Gold
                            Partner
                        </h4>
                        ...
                        <div>
                            <p className='text-base md:text-lg text-foreground mb-6 leading-relaxed'>
                                By partnering with Teckzilla, you don’t just get
                                ERP software—you gain a trusted technology
                                partner invested in your business growth.
                            </p>
                            <p className='text-base md:text-lg text-foreground mb-6 leading-relaxed'>
                                When you’re investing in ERP software, choosing
                                the right partner is just as important as
                                choosing the right solution. An Odoo Gold
                                Partner in Mumbai brings you the highest level
                                of expertise, certified by Odoo itself. Gold
                                Partners are recognized for their proven track
                                record in delivering successful ERP
                                implementations across different industries.
                            </p>
                            <p className='text-base md:text-lg text-foreground mb-6 leading-relaxed'>
                                Working with a Gold Partner means you’re not
                                just hiring a consultant—you’re partnering with
                                a team that deeply understands Odoo’s
                                capabilities, best practices, and customization
                                options. This ensures your business gets a
                                solution tailored to your processes, rather than
                                a one-size-fits-all approach.
                            </p>
                            <p className='text-base md:text-lg text-foreground mb-6 leading-relaxed'>
                                For companies in Mumbai and across India, having
                                a local Gold Partner means faster support,
                                better communication, and access to experts who
                                understand the regional market challenges. With
                                their guidance, you can streamline operations,
                                improve efficiency, and achieve a faster return
                                on investment with Odoo ERP.
                            </p>
                            <p className='text-base md:text-lg text-foreground leading-relaxed'>
                                Are you ready to take your company to the next
                                level? At Teckzilla, we specialize in Odoo ERP
                                software, a powerful tool designed to enhance
                                productivity and streamline business processes.
                                Our expertise ensures the smooth integration of
                                your company’s operations, giving you a
                                competitive edge in today’s fastest growing
                                market.
                            </p>
                        </div>
                    </Card>
                    ...
                    <Card className='card-corporate p-8 mb-8'>
                        ...
                        <p className='text-muted-foreground mb-2'>
                            ...
                            is why our Odoo-certified consultants create
                            tailored ERP roadmaps aligned with your goals.
                        </p>
                        <p className='text-muted-foreground'>
                            As an official Odoo Gold Partner in Mumbai,
                            Teckzilla has successfully delivered ERP solutions
                            across industries like retail, manufacturing,
                    ...
                    <Card className='relative overflow-hidden p-8 bg-gradient-to-br from-primary/5 via-background to-background border-l-8 border-primary shadow-lg rounded-xl  mx-auto mt-8'>
                        ...
                        <p className='text-lg text-muted-foreground leading-relaxed mb-0'>
                            Odoo ERP Software is a comprehensive suite of
                            business tools made to meet the customized needs of
                            modern companies. If you need to manage finances,
                            human resources, sales, inventory, or other areas,
                            Odoo ERP offers a simplified and dynamic interface
                            that simplifies complex tasks. By automating
                            processes, reducing operating costs, and providing
                            insightful performance analysis, Odoo ERP helps your
                            business run more efficiently with making hassle
                            while working on inputs and information to be stored
                            on the Odoo ERP Platform.
                        </p>
                    </Card>
                    ...
                    <Card className='p-8 shadow-xl rounded-xl  mx-auto  mt-8'>
                        ...
                        <p className='text-lg text-muted-foreground mb-6 leading-relaxed'>
                            As a leading Odoo Gold Partners in Mumbai, India,
                            Teckzilla Technologies takes pride in delivering
                            customized solutions that align with your business
                            goals. Our skilled team ensures smooth deployment
                            and ongoing support to maximize the benefits of your
                            Odoo ERP system for your business.
                        </p>
                        <p className='text-lg text-muted-foreground mb-6 leading-relaxed'>
                            Stay ahead with the upcoming Odoo ERP Latest
                            Release. This new version introduces exciting
                            features and improvements designed to further
                            simplify your business operations. Teckzilla Odoo
                            Gold Partner is committed to keeping you updated
                            with the latest ERP technology and ensuring a smooth
                            transition to Odoo ERP Software, consolidating your
                            business functions on a single platform from sales
                            to accounting and from marketing to promotion and
                            advertisement.
                        </p>
                        <p className='text-lg text-foreground flex items-center gap-2 mb-1'>
                            Experience the difference with Teckzilla. Visit us
                            today to discover how our top Odoo ERP solutions can
                            empower and upgrade your business. Hurry! Log in for
                            a free demo!
                        </p>
                    ...
                    <Card className='p-10 flex flex-col items-center justify-center bg-primary/5 shadow-xl rounded-xl mx-auto  mt-8'>
                        ...
                        <p className='text-lg text-center text-muted-foreground mb-6'>
                            Ready to scale your business with the best Odoo Gold
                            Partner in Mumbai?
                        </p>
                        <div className='flex flex-col items-center mb-4'>
                            <span className='text-lg font-medium text-foreground flex items-center gap-2'>
                                Call us today or book a consultation with our
